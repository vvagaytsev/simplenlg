...
public class SPhraseSpec extends PhraseElement {
    ...
    static final List<String> vpFeatures = Arrays.asList(
            Feature.MODAL,
            Feature.TENSE,
            Feature.NEGATED,
            Feature.NUMBER,
    ...
    public SPhraseSpec(NLGFactory phraseFactory) {
        ...
        setFeature(Feature.COMPLEMENTISER, phraseFactory.createWord("that", LexicalCategory.COMPLEMENTISER));
    }
     ...
     *
     * @see NLGElement#setFeature(String, Object)
     */
    @Override
     ...
     *
     * @see simplenlg.framework.PhraseElement#addPreModifier(NLGElement)
     */
    @Override
     ...
     *
     * @see simplenlg.framework.PhraseElement#addComplement(NLGElement)
     */
    @Override
     ...
     * Adds a complement, if possible to the underlying VP.
     *
     * @see simplenlg.framework.PhraseElement#addComplement(String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see simplenlg.framework.NLGElement#setFeature(String, boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see simplenlg.framework.NLGElement#getFeature(String)
     */
    @Override
