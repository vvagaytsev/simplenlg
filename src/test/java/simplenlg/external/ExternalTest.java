...
public class ExternalTest {
    ...
    public void forcherTest() {
        ...
        PhraseElement pp1 = this.phraseFactory.createPrepositionPhrase("with");
        ...
        s2.setSubject(this.phraseFactory.createNounPhrase("Peter"));
        s2.setVerb("have");
        s2.setObject("something to do");
        s2.addPostModifier(this.phraseFactory.createPrepositionPhrase("with", "Paul"));
        Assert.assertEquals(
    ...
    public void luTest() {
        // Xin Lu's test
        this.phraseFactory.setLexicon(this.lexicon);
        PhraseElement s1 = this.phraseFactory.createClause("we", "consider", "John");
        s1.addPostModifier("a friend");
        Assert.assertEquals(
                "we consider John a friend",
                this.realiser.realise(s1).getRealisation()
        );
    }
    ...
    public void dwightTest() {
        ...
        this.phraseFactory.setLexicon(this.lexicon);
        NPPhraseSpec noun4 = this.phraseFactory.createNounPhrase("FGFR3 gene in every cell");
        noun4.setSpecifier("the");

        PhraseElement prep1 = this.phraseFactory.createPrepositionPhrase("of", noun4);
        PhraseElement noun1 = this.phraseFactory.createNounPhrase("the", "patient's mother");
        PhraseElement noun2 = this.phraseFactory.createNounPhrase("the", "patient's father");
        PhraseElement noun3 = this.phraseFactory.createNounPhrase("changed copy");
        ...
        PhraseElement verbPhrase1 = this.phraseFactory.createVerbPhrase("have");
        ...
        noun3 = this.phraseFactory.createNounPhrase("a", "gene test");
        noun2 = this.phraseFactory.createNounPhrase("an", "LDL test");
        noun1 = this.phraseFactory.createNounPhrase("the", "clinic");
        verbPhrase1 = this.phraseFactory.createVerbPhrase("perform");
    ...
    public void novelliTest() {
        ...
        PhraseElement p = this.phraseFactory.createClause("Mary", "chase", "George");

        PhraseElement pp = this.phraseFactory.createPrepositionPhrase("in", "the park");
        ...
        SPhraseSpec run = this.phraseFactory.createClause("you", "go", "running");
        run.setFeature(Feature.MODAL, "should");
        run.addPreModifier("really");
        SPhraseSpec think = this.phraseFactory.createClause("I", "think");
        think.setObject(run);
    ...
    public void piotrekTest() {
        ...
        this.phraseFactory.setLexicon(this.lexicon);
        PhraseElement sent = this.phraseFactory.createClause("I", "shoot", "the duck");
        sent.setFeature(Feature.TENSE, Tense.PAST);

        PhraseElement loc = this.phraseFactory.createPrepositionPhrase("at", "the Shooting Range");
    ...
    public void prescottTest() {
        ...
        this.phraseFactory.setLexicon(this.lexicon);
        PhraseElement embedded = this.phraseFactory.createClause("Jill", "prod", "Spot");
        PhraseElement sent = this.phraseFactory.createClause("Jack", "see", embedded);
    ...
    public void wissnerTest() {
        ...
        PhraseElement p = this.phraseFactory.createClause("a wolf", "eat");
