...
public class CoordinationTest extends SimpleNLG4Test {
    ...
    /**
     * Check that empty coordinate phrases are not realised as {@code null}.
     */
    @Test
    ...
    public void testCoordinateVPComplexSubject() {
        ...
        // first VP
        VPPhraseSpec vp1 = this.phraseFactory.createVerbPhrase(
                this.lexicon.getWord("have", LexicalCategory.VERB)
        );
        NPPhraseSpec np1 = this.phraseFactory.createNounPhrase(
                "a",
                this.lexicon.getWord("contrast media reaction", LexicalCategory.NOUN)
        );
        ...
        PPPhraseSpec pp = this.phraseFactory.createPrepositionPhrase(
                "into",
                this.lexicon.getWord("cardiogenic shock", LexicalCategory.NOUN)
        );
    ...
    /**
     * Test setting a conjunction to {@code null}.
     */
    public void testNullConjunction() {
        ...
        Assert.assertEquals(
                ...
                this.realiser.realise(pq).getRealisation()
        );
    }
