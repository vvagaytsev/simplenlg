...
public class NounPhraseTest extends SimpleNLG4Test {
    ...
    public void testPossessive() {
        ...
        PhraseElement possNP = this.phraseFactory.createNounPhrase("a", "man");
    ...
    public void testCoordination() {
        ...
        // Assert.assertTrue(cnp1.raiseSpecifier()); // should return
        // true as all
    ...
    public void testCoordination2() {
        ...
        NLGElement every = this.phraseFactory.createWord(
                "every", LexicalCategory.DETERMINER);
    ...
    public void testAAn() {
        ...
        PhraseElement elephant = this.phraseFactory.createNounPhrase("a", "elephant");
    ...
    public void testModifier() {
        ...
        PhraseElement cat = this.phraseFactory.createNounPhrase("a", "cat");
        ...
        cat.addPostModifier(this.phraseFactory.createPrepositionPhrase("in", "the park"));
