...
public class InterrogativeTest extends SimpleNLG4Test {
    ...
    protected void setUp() {
        ...
        PhraseElement john = this.phraseFactory.createNounPhrase("John");
        ...
        this.s4 = this.phraseFactory.createClause(subjects, "pick up", "the balls");
    ...
    public void testSimpleQuestions2() {
        setUp();
        this.realiser.setLexicon(this.lexicon);
        PhraseElement s = this.phraseFactory.createClause("the woman", "kiss", "the man");
        ...
        // now in the passive
        s = this.phraseFactory.createClause("the woman", "kiss", "the man");
        s.setFeature(Feature.INTERROGATIVE_TYPE, InterrogativeType.YES_NO);
    ...
    public void testProgrssiveWHObjectQuestions() {
        ...
        Assert.assertEquals("what is Mary eating", this.realiser.realise(p).getRealisation());
